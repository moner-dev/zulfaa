...
- Two small scripts of our own and nothing else: `assets/nav.js` (the menu button and the
  language menu on narrow screens) and `assets/carousel.js` (the screenshot lightbox). Every
...
assets/nav.js       header menu button + language menu (progressive enhancement)
