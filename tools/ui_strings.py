...
S["ar"] = {
    ...
    "showNote": "عشرون صورة من زُلْفَى على أندرويد — الصلاة والقرآن والأذكار والقبلة وتحدّي اليوم، بالوضعين الفاتح والداكن.",
...
S["nl"] = {
    ...
    "showNote": "Twintig beelden uit ZULFAA op Android — gebed, de Koran, adhkar, de qibla en de dagelijkse uitdaging, in een licht en een donker thema.",
