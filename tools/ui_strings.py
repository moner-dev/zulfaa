...
S["en"] = {
    ...
    "topNote": "Version 1.2 is under review for its public release.",
    "menuLabel": "Menu",
...
S["ar"] = {
    ...
    "topNote": "الإصدار 1.2 قيد المراجعة لإطلاقه العلني.",
    "menuLabel": "القائمة",
    ...
    "availTitle": "التوفّر",
    "availNote": "الإصدار 1.2 من زُلْفَى قيد المراجعة لإطلاقه العلني، ولم يُنشر بعد على Google Play. وستحمل هذه الصفحة رابط المتجر عند إتاحته. والواجهة متاحة بالعربية والإنجليزية والهولندية.",
    # support
    ...
    "supPlayA": "ليس بعد. الإصدار 1.2 قيد المراجعة لإطلاقه العلني، وسيحمل هذا الموقع رابط المتجر عند إتاحته.",
...
S["nl"] = {
    ...
    "topNote": "Versie 1.2 wordt beoordeeld voor de publieke release.",
    "menuLabel": "Menu",
    ...
    "availNote": "Versie 1.2 van ZULFAA wordt beoordeeld voor de publieke release en staat nog niet op Google Play. Deze pagina krijgt de winkellink zodra de app openbaar beschikbaar is. De interface is beschikbaar in het Arabisch, Engels en Nederlands.",
    ...
    "supPlayA": "Nog niet. Versie 1.2 wordt beoordeeld voor de publieke release. Deze site krijgt de winkellink zodra de app openbaar beschikbaar is.",
